...
**Schedule: Fast - Full programme (SP1, SP2 and Data Processing) this semester - Expected workload: 20 hrs/week**
...
Here is a **language-improved version**, keeping the **structure, content, and grading logic exactly the same**, but making the wording clearer and more consistent.

For **Data Processing**, you will receive a regular grade on a **1–10 scale**.

Your final grade is determined by the grades for **Level 7**, **Level 8**, and the **final project**, weighted as follows:
...
Note that, although **Levels 9 and 10 do not contribute to the final grade**, you must still submit them correctly in order to pass the course.
...
* For graded assignments, your grade depends on the number of **challenge assignments** you complete.
  ...
  * Correctly completing the base assignments results in a grade of **7**.
  * Additional points are awarded for completed challenges.
* The final project is graded based on **research question**, **complexity**, **novelty**, and **quality**.


#### Final project grade

Your project will be evaluated on **four criteria**:
**Research Question / Project Goal**, **Complexity**, **Novelty / Learning**, and **Quality**.
