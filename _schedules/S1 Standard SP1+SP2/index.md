...
**Track:** Scientific Programming 1 + 2 (standard pace)
...
**You are following the Standard schedule**: Scientific Programming 1 in September and
October, Scientific Programming 2 in November and December.
...
<table class="tracks">
  ...
  <tbody>
    <tr class="dim">
      <th class="sched">Standard <span class="mod">(DP this semester)</span><span class="prior">you already did SP1 + SP2 (or equivalent)</span></th>
      <td class="dp" colspan="4">DP</td>
      <td></td>
    </tr>
    <tr class="dim">
      <th class="sched">Relaxed <span class="mod">(only SP2 this semester)</span><span class="prior">you already did SP1 (or equivalent)</span></th>
...
Here below is an overview of all modules for these courses. Click a module title to read what it is about.
...
**Fall 2026/2027 — SP1 + SP2, Standard pace**
...
Scientific Programming 1 and 2 are pass/fail courses.
