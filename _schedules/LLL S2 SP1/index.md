...
**Track:** Lefelong Learning; Scientific Programming 1
...
The track consists of **these separate courses**:

* **Scientific Programming 1 (SP1)** – 3 EC, pass/fail
* **Scientific Programming 2 (SP2)** – 3 EC, pass/fail

These courses are designed to be taken one after another. 
...
## Deadlines {#deadlines}
**Spring 2025/2026, (LLL SP1)**

| Date            | Deadline  |
|-----------------|-----------|
| Friday 20 Mar   | Module 1  |
| Friday 10 Apr   | Module 2  |
| Friday 24 Apr   | Module 3  |
| Thursday 28 May | Exam SP1  |
